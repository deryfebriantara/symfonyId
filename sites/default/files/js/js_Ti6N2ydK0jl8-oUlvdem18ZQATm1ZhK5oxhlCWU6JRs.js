...
(function ($) {
  ...
  googleMapFieldSetter = function(delta) {
    ...
    dialogHTML += '    <button onclick="return doCentre();" type="button" role="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only button">find</button>';
